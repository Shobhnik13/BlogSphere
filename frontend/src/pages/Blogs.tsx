...
const Blogs = () => {
 const { loading , blogs }=useBlogs()
    if(loading){
      return (
        <div role="status">
          <svg aria-hidden="true" className="w-8 h-8 flex justify-center items-center text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
